classdef Vessel < handle
    ...
    properties (GetAccess = protected, SetAccess = protected)
        ...
        prop_vesID;
        orig_prop_centre;
        orig_prop_keep_inds;      % Indices of 'good' measurements, i.e. measurements to be output
    end
...
%                 val = true(obj.num_diameters, 1);
        ...
        function val = get.orig_centre(obj)
            val = obj.orig_prop_centre;
        end
        % Tie KEEP_INDS to CENTRE in terms of size
        function set.orig_centre(obj, val)
            % Don't allow unless n x 2 or empty
            if isempty(val)
                obj.orig_prop_centre = [];
                obj.orig_prop_keep_inds = [];
            else
                val = valid_points_vector(val);
                if ~isempty(val)
                    obj.orig_prop_centre = val;
                    obj.orig_prop_keep_inds = true(size(val, 1), 1);
                end
            end
        end
        
        function val = get.AV(obj)
            val = obj.prop_AV;
        end
        
        function set.AV(obj, val)
            obj.prop_AV = val;
        end
        
        function val = get.vesID(obj)
            val = obj.prop_vesID;
        end
        
        function set.vesID(obj, val)
            obj.prop_vesID = val;
        end
        
        function set.der(obj, val)
            obj.prop_der = val;
        end
        
        function val = get.der(obj)
            val = obj.prop_der;
        end
    ...
    methods (Static)
        function obj = loadobj(obj)
            if isstruct(obj) || isa(obj, 'Vessel')
                ...
                new_obj.prop_AV = obj.prop_AV;
                new_obj.prop_vesID = obj.prop_vesID;
                new_obj.prop_der = obj.prop_der;
                obj = new_obj;
            end
        end
    end
    ...
    methods
        ...
        function s = saveobj(obj)
            ...
            s.prop_AV = obj.prop_AV;
            s.prop_der = obj.prop_der;
            s.prop_vesID = obj.prop_vesID;
        end
    end
