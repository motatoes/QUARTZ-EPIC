        ...
        function [vessel_data, process_time] = load_from_file(filename, processor, settings)
            ...
            if strcmpi(ext, '.mat')
                ...
                try
                    ...
                    % temp by mmf
                    % d not read it .. it in in the args
                    %vessel_data.im_orig  = vessel_data.im_orig (:, 499:2500,:);
                    ...
                    elseif isstruct(processor)
                        ...
                        vessel_data.bw = args.cI.ves_seg;
                        vessel_data.bw_mask = args.cI.mask;
                        vessel_data.im_orig = args.cI.img;
                    else
